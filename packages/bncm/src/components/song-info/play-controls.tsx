...
import {leftControlButtonTypeAtom, rightControlButtonTypeAtom} from "../config/music";
...
export const PlayControls: FC = () => {
    ...
    return (<div className="am-music-controls">
        ...
        >
            {playStatus === PlayState.Playing ? (<IconPause color="#FFFFFF"/>) : (<IconPlay color="#FFFFFF"/>)}
        </button>
        <button
